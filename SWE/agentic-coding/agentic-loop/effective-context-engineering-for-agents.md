...
- **A same-day companion launch, not a later revision.** On the same date this
  ...
  [Context Editing API and a Memory Tool](/SWE/agentic-coding/context-engineering/claude-context-editing-and-memory-tool.md)
...
- **Independent research reinforces the thesis.** Chroma's
  ["context rot" study](/SWE/agentic-coding/context-engineering/context-rot-chroma-research.md)
