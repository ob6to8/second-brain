...
- [State of AI Coding 2026 (New Relic) — the trust-vs-reliability gap](/SWE/testing/state-of-ai-coding-2026.md) — survey data behind "test features, not code": 62% ship AI code without line-by-line review while 78% see production-incident spikes tied to it (~1.7× more critical runtime issues). `sb:49eae4` _(reference)_
