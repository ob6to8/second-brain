...
The host log is typically a `.jsonl`. The approach is preferred because it yields the exact delivered text rather than a memory reconstruction; it contrasts with render-from-context.
