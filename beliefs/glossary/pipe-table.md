...
It is a [GitHub Flavored Markdown](/beliefs/glossary/github-flavored-markdown.md)
extension. Being plain text, any pipe table in a document *looks* the same to a
naive parser — which is why a tool reading a specific table (this bundle's
