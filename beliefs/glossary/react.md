...
The name fuses **rea**soning and **act**ing. Widely reused as the default strategy in agent frameworks (including [Jido](/beliefs/glossary/jido.md)'s `jido_ai`).

The pattern originates in [ReAct — reasoning + acting as the thought-action-observation loop (Yao et al.)](/knowledge/SWE/agentic/agentic-loop/react-reasoning-and-acting.md).
