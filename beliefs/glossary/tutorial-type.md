...
Distinct from a terse `note` and from a `reference` capture of external material. Lives under `meta/tutorials/`. Defined in the [controlled-type vocabulary](/meta/policy/controlled-type-vocabulary.md).
