...
**In this brain**, `verified_by` is such an edge. The governing principle: type an edge only when a machine must traverse it; otherwise prose carries the semantics.
