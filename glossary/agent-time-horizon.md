...
"a Moore's Law for AI agents." Defined by [Agent task time horizons](/SWE/agentic-coding/agentic-loop/agent-task-time-horizons.md).

*Seen in:* [2026-07-11 news-digest thread](/meta/threads/2026-07-11-news-digest-intake-and-daily-read.md), [Agent task time horizons](/SWE/agentic-coding/agentic-loop/agent-task-time-horizons.md)
