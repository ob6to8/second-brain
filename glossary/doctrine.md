...
The layer of guiding principles and accepted tenets in a governance system — the "why" that shapes judgment without prescribing specific action. Doctrine informs policy; a [policy](/glossary/policy-type.md) implements doctrine as a concrete, enforceable rule. As of 2026-07-12 this brain has a `doctrine` type and a [`meta/doctrine/`](/meta/doctrine/index.md) genre for standing intention statements (first document: [the engineer as orchestrator](/meta/doctrine/engineer-as-orchestrator.md)); the *worldview* doctrine — "the tree is the taxonomy", "distill, don't dump" — still lives distributed across the preamble and compiled [operating contract](/glossary/operating-contract.md) read as a whole, while each `type: policy` file is a single standing rule.
