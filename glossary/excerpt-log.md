...
[sink](/glossary/route-tag-sink.md) carries: append-only, per-thread,
date-stamped blocks, each lifting the [route-tagged](/glossary/route-tag.md)
regions of one thread whole (ATX headers demoted to bold). It is the
[materialized](/glossary/materialize.md) output of the tags — written by
