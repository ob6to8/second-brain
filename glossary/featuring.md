...
The gated decision by which `/research` decides which candidates make the cut — relevance, then novelty, then a [reason tag](/glossary/reason-tags.md) firing, then source quality, under a quality-over-volume cap. Documented in the [`/research` skill](/.claude/skills/research/SKILL.md).
