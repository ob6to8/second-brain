...
merge time. Defined by [Git worktrees for parallel AI agents](/SWE/version-control/git/git-worktrees-for-parallel-agents.md).

*Seen in:* [2026-07-11 news-digest thread](/meta/threads/2026-07-11-news-digest-intake-and-daily-read.md), [Git worktrees for parallel AI agents](/SWE/version-control/git/git-worktrees-for-parallel-agents.md)
