...
the taxonomy (e.g. `/SWE/…`): the file moves, its stable id travels with it,
and a [pointer entry](/glossary/pointer-entry.md) stub stays behind in
`/glossary/` linking to the new home. The glossary is a staging layer, not a
