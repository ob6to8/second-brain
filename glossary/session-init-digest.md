...
description: A machine-compiled summary of a knowledge base's open work — open issues, active plans, and dangling thread strands — injected into a fresh session's context at startup and ending in a heuristic priority ranking for the agent to refine.
...
issues, active plans, and dangling routing-ledger strands, ending in a
