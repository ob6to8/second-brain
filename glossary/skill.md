...
(or shipped in a [plugin](/glossary/plugin.md)), giving the agent a specialized
...
own `SKILL.md`, and the *concept* a skill enacts (e.g. [session capture](/glossary/session-capture.md))
