...
- **Justification** — the record of one derivation step: the set of nodes that
  ...
  the network a [bipartite graph](/glossary/bipartite-graph.md): belief nodes
...
the [blast radius](/glossary/blast-radius.md) of the retracted assumption is
...
this brain is exploring: an [epistemic overlay](/glossary/epistemic-overlay.md)
