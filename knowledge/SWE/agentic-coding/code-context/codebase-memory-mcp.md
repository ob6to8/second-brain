...
bet as [GitNexus](/knowledge/SWE/agentic-coding/code-context/gitnexus.md) — precompute the
...
in [code-context](/knowledge/SWE/agentic-coding/code-context/index.md): pre-built graphs cut
