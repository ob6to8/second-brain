...
- **A same-day companion launch, not a later revision.** On the same date this
  ...
  [Context Editing API and a Memory Tool](/knowledge/SWE/agentic/context-engineering/claude-context-editing-and-memory-tool.md)
...
- **Independent research reinforces the thesis.** Chroma's
  ["context rot" study](/knowledge/SWE/agentic/context-engineering/context-rot-chroma-research.md)
