...
the [agent execution loop](/knowledge/SWE/agentic/agentic-loop/the-agent-execution-loop.md)
...
[designing agentic loops](/knowledge/SWE/agentic/agentic-loop/designing-agentic-loops.md)
...
[time-horizon data](/knowledge/SWE/agentic/agentic-loop/agent-task-time-horizons.md)
...
Append-only, per-thread, date-stamped excerpts, generated from the `<routes ref="em:f02167">` regions of the threads that fed this matter and re-derivable via `mix brain.route_tags` — never hand-edit.

### 2026-07-11-news-digest-intake-and-daily-read (2026-07-11)

1 tagged region(s), lifted whole. Refs shown are the full ref-set of each region (this matter plus any it co-feeds).

**[`em:f02167`]**  (co-feeds: `em:532b22 em:1cac23 em:c29a22 em:8b9548 em:49eae4`)
