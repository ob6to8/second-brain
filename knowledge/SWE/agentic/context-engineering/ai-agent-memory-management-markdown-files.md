...
Append-only, per-thread, date-stamped excerpts, generated from the `<routes ref="em:41a1e3">` regions of the threads that fed this matter and re-derivable via `mix brain.route_tags` — never hand-edit.
