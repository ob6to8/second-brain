...
recommended in [Effective context engineering for AI agents](/knowledge/SWE/agentic/agentic-loop/effective-context-engineering-for-agents.md):
...
supported empirically by [Chroma's context rot research](/knowledge/SWE/agentic/context-engineering/context-rot-chroma-research.md).
