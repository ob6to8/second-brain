...
# Testing methodology for the Elixir Mind tooling
...
- **A pure core wrapped by an IO shell.** `ElixirMind.Frontmatter` and
  `ElixirMind.Policy` are (mostly) pure text/data transforms. `Registry`,
