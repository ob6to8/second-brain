...
[git branches don't auto-advance on fetch](/knowledge/SWE/version-control/git/git-local-branches-dont-auto-advance-on-fetch.md):
...
Append-only, per-thread, date-stamped excerpts, generated from the `<routes ref="em:8b9548">` regions of the threads that fed this matter and re-derivable via `mix brain.route_tags` — never hand-edit.

### 2026-07-11-news-digest-intake-and-daily-read (2026-07-11)

1 tagged region(s), lifted whole. Refs shown are the full ref-set of each region (this matter plus any it co-feeds).

**[`em:8b9548`]**  (co-feeds: `em:532b22 em:1cac23 em:f02167 em:c29a22 em:49eae4`)
