...
Domain knowledge — the taxonomy of what the brain *knows*. Each subdirectory is
a knowledge domain that grew bottom-up from filed concepts. Distinct from
[beliefs](/beliefs/index.md), which holds the brain's own working vocabulary and
observations.
