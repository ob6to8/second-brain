defmodule SecondBrain.Site do
  ...
  `SecondBrain.Frontmatter` and `SecondBrain.Markdown` and the standard library
  ...
  defp build_node(dir, by_dir, all_dirs) do
    ...
    %{
      name: if(dir == "", do: "Second Brain", else: humanize(Path.basename(dir))),
      dir: dir,
      index: index,
      dirs: child_dirs,
      files: files
  ...
  defp render_page(page, tree, id_index, backlinks) do
    ...
    <title>#{esc(page.title)} · Second Brain</title>
    ...
    <header class="topbar">
      ...
      <a class="brand" href="#{p}index.html"><span class="brand-mark">🧠</span> Second Brain</a>
  ...
  defp css, do: SecondBrain.Site.Assets.css()
  defp app_js, do: SecondBrain.Site.Assets.js()
end
