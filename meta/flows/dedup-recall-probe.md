...
> **Lineage** *(generated — `mix brain.lineage`; read [the full chart](/meta/flows/lineage.md)).* Identified in [Would a vector DB improve recall as this bundle scales? A dedup-recall probe says fix intake first](/meta/analysis/vector-db-recall-for-the-scaling-bundle.md) → designed in [Dedup recall probe: a gold set of natural-phrasing queries and a mix task that measures intake dedup recall](/meta/plans/dedup-recall-probe.md) → built in [2026-07-12-dedup-recall-probe-and-synonym-intake](/meta/threads/2026-07-12-dedup-recall-probe-and-synonym-intake.md) → merged in PR #50.
<!-- lineage:end -->
