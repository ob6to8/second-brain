...
flowchart LR
  ...
  f5t --> f5r
  f5r --> f5f
  f6p["plan: research-daily-read-synthesis"]
  f6t["thread: 2026-07-09-home-page-news-filter-inbox, 2026-07-11-news-digest-intake-and-daily-read"]
  f6r["PR #19, #41"]
  f6f["flow: research-inbox"]
  f6p --> f6t
  f6t --> f6r
  f6r --> f6f
  f7p["plan: flows-genre-and-scenario-testing"]
  f7t["thread: 2026-07-08-adopt-session-capture-routing-and-route-tags"]
  f7r["PR #13"]
  f7f["flow: session-capture"]
  f7p --> f7t
  f7t --> f7r
  f7r --> f7f
  f8t["thread: 2026-07-09-github-pages-knowledge-base-site, 2026-07-09-live-render-appraisal-and-pages-hardening"]
  f8r["PR #26, #28"]
  f8f["flow: site-build-and-deploy"]
  f8t --> f8r
  f8r --> f8f
```
