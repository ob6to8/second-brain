...
`/research` writes a daily candidate feed into the [inbox namespace](/glossary/inbox-namespace.md);
...
- The featured set is **already filtered** — `/research` [featuring](/glossary/featuring.md)
