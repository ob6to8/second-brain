---
type: policy
title: Capture the knowledge, cite the source
description: On filing a knowledge document, capture the distilled knowledge — clear title, one-sentence description, clean body — and keep the original material as a resource URI or under a Citations section, rather than filing the raw source as the document.
section: filing
order: 1
status: active
