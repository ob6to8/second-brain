---
type: policy
title: Filenames and cross-linking
description: Kebab-case slug filenames (date-prefixed only for time-ordered entries); cross-link with bundle-absolute markdown links.
section: filing
order: 3
status: active
