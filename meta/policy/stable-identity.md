...
description: Every bundle document carries a stable id whose 6-hex tail is the immutable identity; the namespace prefix changes only by a ratified bundle-wide migration; cross-document edges reference ids, and meta/registry.md is the compiled id-to-path view.
