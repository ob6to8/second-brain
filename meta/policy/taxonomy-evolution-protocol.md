---
type: policy
title: Taxonomy-evolution protocol
description: Subdirectories under an established domain are autonomous; a new top-level directory is proposed and ratified by the operator.
