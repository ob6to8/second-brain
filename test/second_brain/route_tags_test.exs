defmodule SecondBrain.RouteTagsTest do
  use ExUnit.Case, async: true

  alias SecondBrain.RouteTags
  ...
  describe "classify_ref/1" do
    test "sb: ids are concept sinks, everything else is a path back-link" do
      ...
      assert RouteTags.classify_ref("lib/second_brain/route_tags.ex") ==
               {:path, "lib/second_brain/route_tags.ex"}
